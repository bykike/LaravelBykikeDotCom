      ...
      <div class="content">
        ...
        <section id="works">
          <!-- <div class="col-md-12 col-sm-12 col-xs-12 white-col">-->
            <div class="row">
              <img src="works/agricolavillena.jpg" height="100%" width="100%"/>
            </div>
          <!-- </div> -->
        </section>
        <!--/.WORKS END-->
        ...
        <section id="about">
          <div class="col-md-6 col-xs-12 no-pad">
            <div class="">
              <img src="works/pantallaagricola.jpg" alt="work" height="100%" width="100%"/>
            </div>
          </div>
                  ...
                  <div class="wrap-about">
                    <div class="w-content">
                      ...
                      <h3 class="title-small">
                       <span>A bet on success!</span>
                      </h3>
                      <p class="content-detail">
                      A website that shows the company's philosophy with a strong commitment to quality, 
                      both in the selection of raw materials and processes and in customer service.
                      <br><br>
                      For the web design I mainly used Adobe XD along with Illustrator and Photoshop 
                      combining the corporate colours to enhance the branding.
                      </p>
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <br><br>
                JavaScript allowed me to make the application interactive, which means that 
                users can interact with it in a more natural and intuitive way.  
                </p>
              </div>
              <div class="col-md-8 content-right">
                <div class="row">
                    <div >
                      <img src='works/productos.jpg'>
                    </div>
                </div>
              </div>
            </div>
