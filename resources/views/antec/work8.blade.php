    ...
    <div class="content-wrap">
      ...
      <div class="content">
        ...
        <section id="works">
            ...
            <div class="row">
              <img src="works/Rollup_Mockup_Espasana.jpg" height="100%" width="100%"/>
            </div>
        ...
        <section id="about">
          <div class="col-md-6 col-xs-12 no-pad">
            <div class="">
              <img src="works/librillos_clinica_espasana.jpg" alt="work" height="100%" width="100%"/>
            </div>
          </div>
                  ...
                  <div class="wrap-about-work">
                    <div class="w-content-work">
                      ...
                      <h3 class="title-small">
                       <span>Showing health</span>
                      </h3>
                      <p class="content-detail">
                        A clinic that bases its philosophy on personalised attention and treatment for its patients. 
                        The doctor-patient relationship is essential for the success of any treatment, so establishing
                        a close and sincere communication with each of its patients is essential, which is why the visual 
                        media used are fundamental to transmit this idea.
                      </p>
        ...
        <section class="white-bg" id="services">
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-4">
                <h3 class="title-small">
                  <span>Soft and warm colours</span>
                </h3>
                <p class="content-detail">
                  The corporate colours chosen reflect the philosophy of personalised attention and care for each and every patient. 
                  The use of soft and warm colours transmits a sense of calm and wellbeing, which helps them to feel more comfortable and confident 
                  during their treatment and to be informed by the documentation they consult.
                </p>
              </div>
              <div class="col-md-8 content-right">
                <div class="row">
                    <div >
                      <img src='works/tripticoespasana.jpg'>
                    </div>
                </div>
              </div>
            </div>
        ...
        <footer>
          <div class="footer-top">
            <ul class="socials">
              ...
              <li class="unsplash">
                <a href="https://www.flickr.com/people/bykikke/" target="_blank" data-hover="flickr">flickr</a>
              </li>
            </ul>
          </div>
