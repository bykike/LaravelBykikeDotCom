    ...
    <div class="content-wrap">
      ...
      <div class="content">
        ...
        <section id="works">
            ...
            <div class="row">
              <img src="works/notas.jpg" height="100%" width="100%"/>
            </div>
        ...
        <section id="about">
          <div class="col-md-6 col-xs-12 no-pad">
            <div class="">
              <img src="works/notas1.jpg" alt="work" height="100%" width="100%"/>
            </div>
          </div>
                ...
                <div class="col-md-12">
                  <div class="wrap-about">
                    <div class="w-content">
                      ...
                      The app is designed to help you keep track of important tasks and notes. 
                      With it, you can record notes and tasks that need to be done, as well as set 
                      due dates so that you can meet your goals on time.
                      <br><br>
                      In terms of design, I have created an intuitive and easy-to-use user interface,
                       with carefully selected colours and visual elements to make the information 
                       easy to understand.
                      </p>
        ...
        <section class="white-bg" id="services">
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-4">
                <h3 class="title-small">
                  <span>Scale coding</span>
                </h3>
                <p class="content-detail">
                I used HTML and CSS to shape the structure and style of the application.
                For the programming of the application, I mainly used JavaScript and PHP. 
                <br><br>
                JavaScript has allowed me to make the application interactive, which means that users
                 can interact with it in a more natural and intuitive way.   
                <br><br>
                I also used PHP to create the database and to allow the application to communicate
                 with the server and save the user's data. 
                </p>
              </div>
              <div class="col-md-8 content-right">
                <div class="row">
                    <div >
                      <img src='works/notas-code.jpg'>
                    </div>
                </div>
              </div>
            </div>
